...
export const LOCAL_IMAGE_TYPES = [
    "planets", "shapes", "polygons", "triangles", "construction-vehicles", "animals", "fruits", "birds",
    "insects", "vegetables", "desserts", "dinosaurs", "reptiles", "tools", "trucks", "vehicles", "aircrafts",
    "safari-animals", "farm-animals", "under-water", "foods", "tropical-fruits", "balls", "buses", "camping",
    "chemicals", "moons", "galaxy", "stars", "solar-system", "bathroom", "kitchen", "body-parts", "usa-states",
    "usa-capitals", "keyboard", "colors", "ABC", "123", "10s", "seasons", "directions", "activities",
    "adjectives", "emotions", "months", "days-of-week", "opposites",
];
...
export const toImageSlug = name => name.toLowerCase().trim().replace(/[^a-z0-9]+/g, "-").replace(/^-|-$/g, "");
